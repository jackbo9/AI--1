...
> 2026-09-07 复核：本文是四规格接入前的单竖版实验快照。第 19 节 Handoff 所述四规格现已实现，本文 A1／P1 的“暂停 Campaign/Artifact 双写”建议不再适用于当前代码，不得直接执行。零引用 Schema 和纯转发层已在[本轮消融](./ABLATION_EXPERIMENT_2026-09-07.md)处理。原实验数据和推理保留供追溯。
