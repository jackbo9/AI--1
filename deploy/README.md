...
2026-09-13 新增内部试用持久化方案：PostgreSQL、私有 OSS、个人历史软删除、30 天中间资产清理和本地数据迁移工具。部署步骤与回退方式见 [`docs/PILOT_STORAGE_2026-09-13.md`](../docs/PILOT_STORAGE_2026-09-13.md)。现有服务器尚未配置真实 RDS/OSS 凭据，不代表云端迁移已经执行。
