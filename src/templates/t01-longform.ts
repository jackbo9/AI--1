...
export function longformMarkup(
  ...
  const recap = content.recap && assets.recapImage ? `<section class="lf-recap-heading">
      <b class="lf-kicker">赛区回顾</b><h2>精彩，还在继续。</h2><strong>${escapeHtml(content.recap.city)}</strong>${assets.registrationArrow ? `<img src="${escapeHtml(assets.registrationArrow)}" alt="">` : ""}
    </section><figure class="lf-recap"><img src="${escapeHtml(assets.recapImage)}" alt="赛区赛事照片"><figcaption>01 / ${escapeHtml(content.recap.city)} · ${escapeHtml(content.recap.caption)}</figcaption></figure>` : "";
  ...
  return {
    html: `<main class="t01-extra t01-longform" lang="zh-CN" data-background-mode="full_bleed_background">
      ...
      <section class="lf-title-block" data-readability="title-block"><p class="lf-eyebrow">${escapeHtml(eyebrow)}</p><h1 class="lf-title" data-capacity="title" data-max-lines="3">${escapeHtml(content.title)}</h1>${content.description ? `<p class="lf-description" data-capacity="description" data-max-lines="2">${escapeHtml(content.description)}</p>` : ""}</section>
    ...
    css: `
      ...
      .lf-title-block{position:absolute;z-index:2;left:64px;top:222px;width:952px;display:flex;flex-direction:column;gap:22px;color:#151515}.lf-eyebrow{font-size:26px;font-weight:600;line-height:32.5px}.lf-title{width:952px;font-size:125px;font-weight:700;line-height:1.04}.lf-description{width:952px;font-size:28px;font-weight:600;line-height:35px}
      .lf-kicker{display:block;width:max-content;height:37px;padding:5px 10px;background:#181818;color:#f2f2ee;font-size:21px;line-height:25.2px}
      .lf-when{position:absolute;z-index:2;left:64px;top:1244px;width:952px;height:215px}.lf-when>h2{position:absolute;left:168px;top:0;width:724px;font-size:32px;font-weight:800;line-height:38.4px}.lf-line{position:absolute;background:#c8c8c1}.lf-line.horizontal{left:0;width:952px;height:1px}.lf-line.horizontal.top{top:63px}.lf-line.horizontal.bottom{top:195px}.lf-line.vertical{left:502px;top:63px;width:1px;height:132px}
