...
export function longformMarkup(
  ...
  return {
    ...
    css: `
      ...
      .lf-background{position:absolute;left:0;top:0;width:1080px;height:1210px;object-fit:cover;object-position:center top;z-index:0}.lf-information-panel{position:absolute;left:0;top:1210px;width:1080px;height:calc(var(--lf-canvas-height) - 1210px);background:#f2f2ee;z-index:1}
