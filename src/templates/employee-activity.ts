...
export const employeeActivityTemplate = {
  ...
  version: "2.2.0-figma-typography",
...
export function employeeActivityPosterMarkup(
  ...
  const styles = [
    ...
    ".poster { position: relative; width: 1080px; height: 1920px; overflow: hidden; background: #fff; } .background { position: absolute; inset: 0 0 660px; width: 100%; height: 1260px; object-fit: cover; object-position: center top; } .info-panel { position:absolute; z-index:1; top:1260px; width:1080px; height:660px; background:#F2F2EE; }",
