  ...
  return {
    html: `<main class="t01-extra ${banner ? "t01-banner" : "t01-landscape"}" lang="zh-CN" data-background-mode="full_bleed_background">
      ...
      <section class="t01-wide-title-block" data-readability="title-block">
        ...
        ${textSlot("title", content.title, 3)}
    ...
    css: `
      ...
      .t01-wide-eyebrow{font-size:26px;font-weight:600;line-height:32.5px}
      .t01-wide-title{width:100%;font-size:164px;font-weight:700;line-height:170.56px}
      .t01-wide-description{width:100%;font-size:28px;font-weight:600;line-height:35px}
      .t01-landscape-info{position:absolute;left:64px;top:807px;width:1792px;height:225px;color:#181818}
      .t01-guide{position:absolute;left:0;top:0;width:290px;height:218px}.t01-guide>b{display:block;width:max-content;height:37px;padding:5px 10px;background:#181818;color:#f2f2ee;font-size:21px;line-height:25.2px}.t01-guide h2{position:absolute;left:0;top:57px;width:290px;font-size:39px;font-weight:800;line-height:46.8px}
      .t01-registration-cta{position:absolute;left:0;top:135px;height:37px;display:flex;align-items:center;gap:28px}.t01-registration-cta span{display:block;min-width:130px;height:37px;padding:5px 10px;background:#f7e600;font-size:21px;font-weight:700;line-height:25.2px}.t01-registration-arrow{width:33px;height:33px}
      ...
      .t01-fact{position:absolute;display:flex;flex-direction:column;gap:17px;overflow:hidden}.t01-fact h3{display:flex;gap:14px;font-size:23px;font-weight:700;line-height:27.6px}.t01-fact h3 span{width:32px;color:#75756f;font-size:20px;font-weight:600;line-height:24px}.t01-wide-fact-copy{font-size:29px;font-weight:600;line-height:34.8px}.t01-time{left:344px;top:0;width:530px}.t01-location{left:344px;top:115px;width:530px}.t01-location .t01-wide-fact-copy{font-size:30px;line-height:36px}.t01-audience{left:942px;top:0;width:600px}.t01-rules{left:942px;top:115px;width:600px}.t01-rules .t01-wide-fact-copy{font-size:28px;line-height:33.6px}.t01-deadline{position:absolute;left:0;top:88px;width:600px;color:#75756f;font-size:20px;line-height:24px}
      ...
      .t01-banner .t01-wide-title-block{top:220px;width:1393px}.t01-banner .t01-wide-title{font-size:168px;font-weight:600;line-height:1.04}.t01-banner .t01-wide-background{height:950px}
    `
  };
}
