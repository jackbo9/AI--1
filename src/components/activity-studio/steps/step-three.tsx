...
export function StepThree({ job, visualIdea, visualDescription, onIdea, onDescription, onRefine, onBack, onConfirm, pendingRefine, pendingConfirm, renderTargets, fixtureMode }: { job?: ActivityJob; visualIdea: string; visualDescription: string; onIdea: (value: string) => void; onDescription: (value: string) => void; onRefine: () => void; onBack: () => void; onConfirm: () => void; pendingRefine: boolean; pendingConfirm: boolean; renderTargets: RenderTargetId[]; fixtureMode: boolean }) {
