...
> 本文保留阶段任务及原始验收上下文；当前已实现四规格和二维码上传，不再受下文早期“仅竖版／不上传”限制。当前进度见 HANDOFF 第 18–20 节，待办来源索引见 [2026-09-07 消融记录](./docs/ABLATION_EXPERIMENT_2026-09-07.md)。未勾选项需结合后续交接记录核对，不能据此重做已完成功能。
